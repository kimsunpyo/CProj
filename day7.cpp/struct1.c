...
int main1() {
	...
	char* munu1 = "아메리카노", * menu2 = "에스프레소", * menu3 = "카페라떼", * menu4 = "카페모카", * menu5 = "카라멜 마끼야또";
	int price1 = 1500, price2 = 1000, price3 = 2500, price4 = 2500, price5 = 3000;

	// (2) 배열
	// 같은 주제의 변수들을 뭉쳐놓음, 반복분 사용O, 코드찾기 오래걸림, 코드 너무 길어짐
	// 무슨 주제로 묶었는지 까먹게됨, 짝꿍을 잘 찾아줘야함
	...
	struct menu cafe[5] = { {"아메리카노",1500}, {"에스프레소",1000}, {"카페라뗴",2500}, {"카페모카",2500}, {"카라멜마끼야또",3000}};
